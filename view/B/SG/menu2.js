...
<script>\
    document.addEventListener("DOMContentLoaded", function(){\
        ...
        if(memberEmail == null || memberEmail == "") {\
            ...
            document.getElementById("favoriteLink").setAttribute("style", "display:none");\
        }\
        else {\
    ...
    <div class="container">\
        ...
        <div id="menuLoggedOut" style="display: none;">\
            <nav>\
                ...
                <li class="services">\
                        <a href="/B/' + countryPrefix + '/services.html"><i class="fa-regular fa-handshake"></i></i>Services</a>\
                    </li>\
                    ...
                    <li>\
                        <a href="/B/' + countryPrefix + '/contactUs.html"><i class="fa-solid fa-envelope"></i>Contact Us</a>\
                    </li>\
                </ul>\
        ...
        <div id="menuLoggedIn" style="display: none;">\
            <nav>\
                <ul class="nav nav-pills nav-top">\
                    ...
                    <li>\
                        <a href="/B/' + countryPrefix + '/contactUs.html"><i class="fa-solid fa-envelope"></i></i>Contact Us</a>\
                    </li>\
                    <li>\
            ...
            <nav class="nav-main mega-menu">\
                <ul class="nav nav-pills nav-main" id="mainMenu">\
                    ...
                    <li class="dropdown">\
                        ...
                        <li><a id="favoriteLink" href="FavouriteCategory.html"><i class="icon"></i> Favourite</a></li>\
                </ul>\
            </nav>\
        </div>\
</header>');